...
time_data<-as_datetime(animal_data$time_seen,tz="GMT")
...
barp+geom_bar(stat = "identity",fill="red",color="black")+theme_classic()+labs(x="Time of the day",y="Number of Image")+
  scale_x_discrete(breaks=Bar_chart$class,labels=c("0530-1830 hrs","1831-0529 hrs"))
```

The final out come from the data is that most of the TIGERS indivduals have 1-10 pics, while most of the images are from camera trap data. The picture send by the naturlist , dead animals are also significanat. 

Finally, most of the picture are taken in the night times
