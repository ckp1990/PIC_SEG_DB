...
plot_hist+geom_histogram(binwidth =10,color="white",fill="black")+ theme_classic()+labs(x="Number of Images per individual",y="Count")+xlim(c(0,150))+ylim(c(0,300))+annotate(geom = "text",x=100,y=250,
