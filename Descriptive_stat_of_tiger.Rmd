...
number<-cmpd_plot+geom_bar(stat="identity",position =position_dodge(0.9) )+
  ...
  ylim(c(0,28000))+
  labs(x="Different mode of images captures",y="Number of images",label="Species")+
  theme_classic()+
  scale_fill_manual(name="",values=c("Darkblue","green"),labels=c("Tiger","Leopard"))+
  scale_x_discrete(labels=c("Picture from camera-trap","Photo by Naturlist","Other images"))
...
ind<-cmpd_plot_ind+geom_bar(stat="identity",position =position_dodge(0.9) )+
  geom_text(aes(label=count),hjust=0.25,vjust=-1,size=3,position = position_dodge(0.9),angle=40)+
  ylim(c(0,2000))+
  labs(x="Different mode of images captures",y="Number of individuals",label="")+
  theme_classic()+
  scale_fill_manual(name="",values=c("Darkblue","green"),labels=c("Tiger","Leopard"))+
  scale_x_discrete(labels=c("Photo from camera trap","Photo by Naturlist","Other images"))
...
hist_p+geom_bar(stat="identity",position = position_dodge(0.9))+labs(x="Images per individuals",y="Individual")+theme_classic()+
  ylim(c(0,1500))+geom_text(aes(label=count),hjust=0.2,vjust=-1,size=2,position = position_dodge(0.9),angle=20)+
...
spread_plot+geom_point(shape=19,size=1.6)+labs(x="Number of left flank image per individuals \n (in log scale base 10)",y="Number of right flank image per individuals\n(in log base 10 scale)")+
...
barp+geom_bar(stat = "identity",color="black",position = position_dodge(0.9))+
  theme_classic()+labs(x="Time of the day",y="Number of Image")+
  scale_x_discrete(breaks=unique(Bar_chart$class),labels=c("day image","Night images"))+
...
ind_site<-plot_img<-ggplot(data = img_site,aes(x=site,y=disti_ind,fill=name))+geom_bar(stat = "identity",position = position_dodge(0.9))+theme_classic()+theme(axis.text.x = element_text(angle = 45,vjust = 0.5))+
